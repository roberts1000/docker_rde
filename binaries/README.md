This file holds binaries you want copied to a container. All files are copied to the ~/binaries directory at build time. At a minimum, you must supply files named:
